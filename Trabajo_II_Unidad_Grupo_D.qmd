...
author: "Nilson Julca Celiz, Lleyner Roman Peña, Alex Quispe Agular y Gimena Vega Chavez"
format: 
  html:
    toc: true
    toc-location: left
...
# Análisis de varianza en Soil Plant Analysis Development (spad_20) en respuesta a tratamientos de riego y genotipos de papa
...
Con el análisis de varianza (ANOVA) se hizo con el fin de poder examinar diferentes factores (bloques, tratamiento de riego, genotipo * riego) sobre el índice de spad_29.
Según el grafico y resultado en este caso el efecto significativo de los genotipos sugiere que el índice de spad_29 podría verse como un criterio de selección efetivo para identificar genotipos de papa para poder ver las mejores condiciones de estrés hídrico.
